...
function ConfigEdit({ isConfigEdit, setConfigEdit }) {
    return (
        <>
            <div className={`fixed inset-0 bg-gray-900 opacity-80 ${isConfigEdit ? 'block' : 'hidden'} transition-opacity`} aria-hidden="true"></div>
            <div className={`fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto ${isConfigEdit ? 'block' : 'hidden'}`} aria-hidden="true">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <div className="p-6 space-y-6">
                            <div className="grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hotline</label>
