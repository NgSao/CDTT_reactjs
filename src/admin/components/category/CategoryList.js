...
function CategoryList() {
    ...
    return (
        <div className='mb-20'>
                            ...
                            <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                ...
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Danh mục</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Danh sách danh mục</h1>
                    </div>
                                        ...
                                        return (
                                            <tr key={index} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400 flex flex-row items-start">
                                                    <img
                                                        src={`${ImageApi}/images/category/${category.thumbnail}`}
                                                        alt={category.thumbnail}
                                                        className="w-16 h-16 object-cover"
                                                    />
                                                    <div className='flex flex-col ml-2'>
                                                        <div className="text-base font-semibold text-gray-900 dark:text-white">{category.name}</div>
                                                        <div className="text-sm font-normal text-gray-500 dark:text-gray-400">{category.slug}</div>
                                                    </div>
                                                </td>
                                                <td className="max-w-sm p-4 overflow-hidden text-base font-normal text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{category.description}</td>
            ...
            <CategoryAdd isCategoryAdd={isAdd} setCategoryAdd={setAdd} />
            <CategoryDelete isCategoryDelete={isDelete} setCategoryDelete={setDelete} />
            <CategoryEdit isCategoryEdit={isEdit} setCategoryEdit={setEdit} initialImage={'https://minhtuanmobile.com/uploads/products/iphone-15-yellow-230913032308-230913152308_thumb.png'} />
