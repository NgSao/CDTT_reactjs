...
function ProductList() {
    ...
    return (
        <div>
            <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                <div className="w-full mb-1">
                            ...
                            <ol className="inline-flex items-center space-x-1 text-sm font-medium md:space-x-2">
                                ...
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 text-gray-400 md:ml-2 dark:text-gray-500" aria-current="page">Sản phẩm</span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                        <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Danh sách sản phẩm</h1>
                    </div>
                    <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                        ...
                        <button onClick={() => setProductAdd(true)} className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 bg-blue-700 hover:bg-blue-900 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-600 dark:hover:bg-green-700 focus:outline-none dark:focus:ring-green-800" type="button" data-drawer-target="drawer-create-product-default" data-drawer-show="drawer-create-product-default" aria-controls="drawer-create-product-default" data-drawer-placement="right">
                            Add new product
                        </button>
                    </div>
                </div>
                                        ...
                                        return (
                                            <tr key={index} className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                ...
                                                <td className="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400 flex flex-row items-start">
                                                    <img
                                                        src={`${ImageApi}/images/product/${product.image}`}
                                                        alt={product.image}
                                                ...
                                                <td class="p-4 text-base font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                                    <div className="flex items-center">
                                                        {product.qty === null ? (
                                                            ...
                                                            <>
                                                                <div
                                                                    className={`h-2.5 w-2.5 rounded-full mr-2 ${product.qty < 10 ? 'bg-red-500' : 'bg-green-500'}`}
                                                                ></div>
                                                                {product.qty}
                                                            </>
                                                        )}
            ...
            <ProductEdit isProductEdit={isProductEdit} setProductEdit={setProductEdit} />
            <ProductDelete isProductDelete={isProductDelete} setProductDelete={setProductDelete} />
            <ProductAdd isProductAdd={isProductAdd} setProductAdd={setProductAdd} />
