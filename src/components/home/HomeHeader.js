                    ...
                    <div className="basis-1/5 flex flex-row items-center cursor-pointer gap-1">
                        ...
                        <Link to='/cart'>
                            <div>
                                ...
                                <div className="text-xs font-medium hover:text-red-700">{totalQuantity} SẢN PHẨM</div>
                            </div>
                        </Link>
                    </div>
                    {/* <div className="basis-1/5 flex flex-row items-center cursor-pointer gap-1">
                        ...
                        <Link to='/products'>
                            <div>
                                <div className="text-xs font-bold hover:text-red-700">Sản phẩm</div>
                                <div className="text-xs font-medium  text-red-700">TẤT CẢ</div>
                            </div>
                        </Link>
