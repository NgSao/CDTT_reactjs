        ...
        <div className='mt-10 mb-10'>
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
                {items && items.length > 0 && items.map((item, index) => {
                    return (
                        <div key={index} onClick={() => handleProductClick(item.id)} className='border-2 border-gray-200 rounded-lg relative pb-4 bg-white cursor-pointer'>
                            ...
                            <div className="mx-3">
                                ...
                                <div className='flex flex-row justify-between mt-2'>
                                    <div className='text-base font-bold text-red-700'>{formatCurrency(item.pricebuy)}</div>
